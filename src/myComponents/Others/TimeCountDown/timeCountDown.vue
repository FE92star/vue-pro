...
<!-- 传入的时间格式可以包括：
    ...
    Mon Nov 11 2019 23:59:59 GMT+0800 (中国标准时间)
-->
<template>
  ...
  methods: {
    ...
    initTime() {
      ...
      this.timer = setInterval(() => {
        ...
        // 计算时间
        this.days = Math.floor(totalTimeStamp / 1000 / 60 / 60 / 24) // 天数
        this.hours = Math.floor(totalTimeStamp / 1000 / 60 / 60 % 24) // 小时数
        this.minutes = Math.floor(totalTimeStamp / 1000 / 60 % 60) // 分钟数
        this.seconds = Math.floor(totalTimeStamp / 1000 % 60) // 秒数
      }, 1000)
    },
    /* 格式化时间 */
    timeFormate(time) {
